                  ...
                  children: [
                    IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => RiwayatTransaksiPage()),
                        );
                      },
                    ),
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => TiketSayaScreen(username: username), // Pass username here
                          ),
                        );
                      },
                    ),
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => ProfilScreen(username: username)), // Navigate to ProfilScreen
              );
            },
          ),
          ListTile(
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => RiwayatTransaksiPage()), // Navigate to RiwayatTransaksiScreen
              );
            },
          ),
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => TiketSayaScreen(username: username)), // Navigate to TiketSayaScreen
              );
            },
          ),
          Divider(),
